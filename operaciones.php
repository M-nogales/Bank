...
<body>
  <header>
    <nav class="top-nav">
      <a class="logo" href=""><svg fill="url(#grad)" viewBox="0 0 32 32" version="1.1"
      ...
      <ul class="top-ul">
       ...
       .5-.5v-1a.5.5 0 0 0-.5-.5zM0 11v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-1z" />
        ...
        <li class="li-pc li-pc-extra"><a href=""><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              viewBox="0 0 16 16">
        ...
        <li class="top-li"><a class="top-a" href=""><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              viewBox="0 0 16 16">
    ...
    <main class="w-100 m-auto log_width">
      <form class="p-5" action="php/operaciones.php" method="POST">
        ...
        <div class="form-floating mt-2 mb-4">
          <input type="number" class="form-control pt-4" id="Cantidad" name="Cantidad" placeholder="Clave">
          <label for="Cantidad">Cantidad</label>
        </div>

        <button class="btn btn-primary w-100 mb-3 mt-2" type="submit">Realizar Operación</button>
      </form>
    </main>
  </section>
</body>
